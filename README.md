...
> این نسخه شامل یک **بخش جدید مبتنی بر هوش مصنوعی** برای حل مسائل شیمی نیز می‌باشد.
...
- **بخش هوش مصنوعی** برای حل مسائل شیمی با تحلیل ساده و کاربردی
...
> This version includes a new **AI-powered problem solver** to assist with chemistry questions.
...
- **AI section** for simplified analysis and solving of chemistry problems
