...
const elements = {
    ...
    50: {
        ...
        "state": "جامد",
        "isotopes": [
            { "neutrons": 48, "mass": 98, "name": "قلع-98" },
            { "neutrons": 49, "mass": 99, "name": "قلع-99" },
            { "neutrons": 50, "mass": 100, "name": "قلع-100" },
            { "neutrons": 51, "mass": 101, "name": "قلع-101" },
            { "neutrons": 52, "mass": 102, "name": "قلع-102" },
            { "neutrons": 53, "mass": 103, "name": "قلع-103" },
            { "neutrons": 54, "mass": 104, "name": "قلع-104" },
            { "neutrons": 55, "mass": 105, "name": "قلع-105" },
            { "neutrons": 56, "mass": 106, "name": "قلع-106" },
            { "neutrons": 57, "mass": 107, "name": "قلع-107" },
            { "neutrons": 58, "mass": 108, "name": "قلع-108" },
            { "neutrons": 59, "mass": 109, "name": "قلع-109" },
            { "neutrons": 60, "mass": 110, "name": "قلع-110" },
            { "neutrons": 61, "mass": 111, "name": "قلع-111" },
            { "neutrons": 62, "mass": 112, "name": "قلع-112" },
            { "neutrons": 63, "mass": 113, "name": "قلع-113" },
            { "neutrons": 64, "mass": 114, "name": "قلع-114" },
            { "neutrons": 65, "mass": 115, "name": "قلع-115" },
            { "neutrons": 66, "mass": 116, "name": "قلع-116" },
            { "neutrons": 67, "mass": 117, "name": "قلع-117" },
            ...
            { "neutrons": 73, "mass": 123, "name": "قلع-123" },
            { "neutrons": 74, "mass": 124, "name": "قلع-124" },
            { "neutrons": 75, "mass": 125, "name": "قلع-125" },
            { "neutrons": 76, "mass": 126, "name": "قلع-126" },
            { "neutrons": 77, "mass": 127, "name": "قلع-127" },
            { "neutrons": 78, "mass": 128, "name": "قلع-128" },
            { "neutrons": 79, "mass": 129, "name": "قلع-129" },
            { "neutrons": 80, "mass": 130, "name": "قلع-130" },
            { "neutrons": 81, "mass": 131, "name": "قلع-131" },
            { "neutrons": 82, "mass": 132, "name": "قلع-132" },
            { "neutrons": 83, "mass": 133, "name": "قلع-133" },
            { "neutrons": 84, "mass": 134, "name": "قلع-134" },
            { "neutrons": 85, "mass": 135, "name": "قلع-135" },
            { "neutrons": 86, "mass": 136, "name": "قلع-136" },
            { "neutrons": 87, "mass": 137, "name": "قلع-137" }
        ]
    },
    51: {
